...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void RadioButton1_CheckedChanged(object sender, EventArgs e)
    {
        if (RadioButton1.Checked)
        {
            ...
            Response.Redirect("AddNewRecord.aspx?userid=" + LabelName.Text.ToString());
    ...
    {
        Response.Redirect("AdminCreateUser.aspx?userid=" + LabelName.Text.ToString());
    }

    protected void Button2_Click(object sender, EventArgs e)
    {
        Response.Redirect("AdminManageUserAccounts.aspx?userid=" + LabelName.Text.ToString());
    }
    ...
    {
        Response.Redirect("AdminManageRecordStatus.aspx?userid=" + LabelName.Text.ToString());
    }
    protected void Button7_Click(object sender, EventArgs e)
    {
        Response.Redirect("AdminUpdateRecord.aspx?userid=" + LabelName.Text.ToString());
    }
    protected void Button8_Click(object sender, EventArgs e)
    {
        Response.Redirect("AdminSearchIn_House.aspx?userid=" + LabelName.Text.ToString());
    }
    protected void Button9_Click(object sender, EventArgs e)
    {
        Response.Redirect("AdminSearch_Purchased.aspx?userid=" + LabelName.Text.ToString());
    }
    protected void Button10_Click(object sender, EventArgs e)
    {
        Response.Redirect("AdminReports.aspx?userid=" + LabelName.Text.ToString());
    }
