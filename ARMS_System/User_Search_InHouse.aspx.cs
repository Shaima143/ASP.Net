...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Label34.Text = Request.QueryString["userid"];
        }
    }
    ...
    {
        Response.Redirect("UserAddNewRecord.aspx?userid=" + Label34.Text.ToString());
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        Response.Redirect("UserUpdateRecord.aspx?userid=" + Label34.Text.ToString());
    }
    protected void Button3_Click(object sender, EventArgs e)
    {
        Response.Redirect("User_Search_InHouse.aspx?userid=" + Label34.Text.ToString());
    }
    protected void Button4_Click(object sender, EventArgs e)
    {
        Response.Redirect("User_Search_Purchased.aspx?userid=" + Label34.Text.ToString());
    }
    protected void Button5_Click(object sender, EventArgs e)
    {
        Response.Redirect("User_Reports.aspx?userid=" + Label34.Text.ToString());
    }
