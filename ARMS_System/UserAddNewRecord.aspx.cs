...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("UserAddNewRecord.aspx?userid=" + Label3.Text.ToString());
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        Response.Redirect("UserUpdateRecord.aspx?userid=" + Label3.Text.ToString());
    }
    protected void Button3_Click(object sender, EventArgs e)
    {
        Response.Redirect("User_Search_InHouse.aspx?userid=" + Label3.Text.ToString());
    }
    protected void Button4_Click(object sender, EventArgs e)
    {
        Response.Redirect("User_Search_Purchased.aspx?userid=" + Label3.Text.ToString());
    }
    protected void Button5_Click(object sender, EventArgs e)
    {
        Response.Redirect("User_Reports.aspx?userid=" + Label3.Text.ToString());
    }
    ...
    protected void RadioButton2_CheckedChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("UserAddRecordPurchased.aspx?userid=" + Label3.Text.ToString());
    ...
    protected void Button11_Click(object sender, EventArgs e)
    {
        if (RadioButton1.Checked)
        {
            ...
            else
            {
                 //con.Open();
                cmd.Connection = con;
                cmd.CommandText = "Select UserID from UserDetails where Name='" + Label3.Text + "'";
